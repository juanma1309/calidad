...
namespace Sys.Inventarios.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult ListaClientes(string val, string valSearch, int? page)
        {
            ...
            if (string.IsNullOrEmpty(valSearch))
                objEmpresas = repository.FindEntitySet<Empresas>(c => c.Estatus == true && c.Tipo_Id==3).OrderBy(c => c.NombreEmpresa).ToList();
            else
                objEmpresas = repository.FindEntitySet<Empresas>(c => c.Estatus == true && c.Tipo_Id == 3 && (
        ...
        public ActionResult Add(Empresas objEmpresa)
        {
            ...
            if (objEmpresa.Id > 0)
            {
                ...
                if (objUpdateEmp != null)
                {
                    ...
                    strMensaje = "Se actualizo el cliente";
                    okResult = true;
                }
            }
            else
        ...
        public JsonResult FileUpload(HttpPostedFileBase file)
        {
            ...
            try
            {
                if (file != null && file.ContentLength > 0)
                {
                    ...
                    fName = "Cliente_" + DateTime.Now.Year + DateTime.Now.Month + DateTime.Now.Day + DateTime.Now.Hour + DateTime.Now.Minute + DateTime.Now.Second + DateTime.Now.Millisecond;
